    ...
    <div class="app-content">
        ...
        <div class="row g-4">
            ...
            <div class="card card-primary card-outline mb-4">
                ...
                @endif
                <!--begin::Form-->
                <form class="needs-validation" novalidate method="POST" action="{{ route('lpj.store') }}" enctype="multipart/form-data">
                    @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="ketua_pelaksana_id" id="ketua_pelaksana_id" required>
                                <option>Pilih PenanggungJawab</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="dokumentasi[]" type="file" class="form-control" id="dokumentasi" multiple/>
                        </div>
                    </div>
                </div>
                <!--end::Body-->
