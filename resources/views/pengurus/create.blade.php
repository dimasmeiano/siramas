    ...
    <div class="app-content">
        ...
        <div class="row g-4">
            ...
            <div class="card card-primary card-outline mb-4">
                ...
                @endif
                <!--begin::Form-->
                <form class="needs-validation" novalidate method="POST" action="{{ route('pengurus.store') }}" enctype="multipart/form-data">
                    @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="tanggal_lahir" class="form-label">Tanggal Mulai Jabatan</label>
                            <input
                            type="date"
                            class="form-control"
                            id="tanggal_mulai"
                        ...
                        <div class="col-md-6">
                            <label for="tanggal_lahir" class="form-label">Tanggal Berakhir Jabatan</label>
                            <input
                            type="date"
                            class="form-control"
                            id="tanggal_akhir"
